...
void menu_selection(){
	if (current_menu == 2 && current_row == current_row_max && button_state == 0)			// Go to Main menu if in Settings and button pressed on the "Back to menu" row
	{
	...
	else if (current_row == 4 && button_state == 0 && current_menu == 2)					// Go to Select character menu if in Settings menu and button pressed on the corresponding row
	{
...
void menu_select_choice(){
	if (current_row == 3 && button_state == 0)
	{
		selected_character = 1;

	}
	else if (current_row == 4 && button_state == 0)
	{
		selected_character = 2;

	}
	else if (current_row == 5 && button_state == 0)
	{
