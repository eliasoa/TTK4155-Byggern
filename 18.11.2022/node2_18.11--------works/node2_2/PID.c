...
int16_t error[2]={0,0};			// current error (error[0] and error sum (error[1])
...
int16_t pid_controller(int16_t setpoint, int16_t processvalue){
	...
	// Error correction. Error set to zer0 if within limit
